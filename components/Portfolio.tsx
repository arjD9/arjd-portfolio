        ...
        <div className="max-w-[860px] mx-auto px-5 md:px-8 flex items-center justify-between py-5 md:py-6">
          ...
          <div className="flex md:hidden items-center gap-3">
            ...
            <button
              ...
              aria-label="Menu"
              className={`relative w-10 h-10 rounded-full border flex items-center justify-center transition-all duration-300 ${menuOpen
            ...
            >
              ...
              {[
                ...
                <motion.span
                  ...
                  className={`absolute w-1.5 h-1.5 rounded-full ${menuOpen
              ...
              <div className="px-4 py-3 flex flex-col">
                {NAVITEMS.map((n, i) => (
                  <motion.button
                    ...
                    onClick={() => go(n.id)}
                    className={`flex items-center justify-between py-3.5 px-3 rounded-xl transition-all duration-150 group ${active === n.id
